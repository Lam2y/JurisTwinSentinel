...
def dashboard(db: Session = Depends(get_db), user: User = Depends(current_user)):
    ...
    return {
        ...
        "summary": "Flagship income-document decision aligned; two lower-priority conflicts remain." if resolved else "Three decision conflicts require immediate alignment across active customer cases.",
