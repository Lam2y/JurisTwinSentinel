...
class Settings:
    ...
    WEBHOOK_SECRET = os.getenv("WEBHOOK_SECRET", "juristwin-finals-webhook-secret")
    PROOF_SIGNING_SECRET = os.getenv("PROOF_SIGNING_SECRET", "juristwin-finals-proof-signing-secret")
