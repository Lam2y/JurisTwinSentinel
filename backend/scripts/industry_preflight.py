...
def main():
    ...
    with TestClient(app) as c:
        ...
        hj=health.json()
        passed.append(ok('Service health',health.status_code==200 and hj.get('version')=='5.4.0',hj.get('version','?')))
        ...
        finals=c.get('/finals')
        frontend_ok=finals.status_code==200 and '/static/sentinel.css?v=5.4.0' in finals.text and '/static/sentinel.js?v=5.4.0' in finals.text
